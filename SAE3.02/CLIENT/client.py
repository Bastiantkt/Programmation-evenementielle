...
# ------------
    ...
    def init_ui(self):
        ...
        grille.addWidget(self.envoie_button, 3, 0, 1, 2)
        grille.addWidget(self.resultat_text, 4, 0, 5, 2)
        self.setLayout(grille)
        self.show()

    def Ombre(self, widget):
        ombre = QtWidgets.QGraphicsDropShadowEffect()
        ombre.setBlurRadius(10)
        ombre.setOffset(3, 3)
        ombre.setColor(QtGui.QColor(0, 0, 0, 80))
